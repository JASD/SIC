...
public class TransaccionController implements Serializable {
    ...
    @EJB
    private com.sic.facade.TransaccionFacade ejbFacade;
    ...
    public String prepareCreate() {
        ...
        current.setTransaccionPK(new com.sic.entity.TransaccionPK());
        return "Create";
    }
    ...
    public static class TransaccionControllerConverter implements Converter {
        ...
        com.sic.entity.TransaccionPK getKey(String value) {
            com.sic.entity.TransaccionPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.sic.entity.TransaccionPK();
        ...
        String getStringKey(com.sic.entity.TransaccionPK value) {
