...
public class PeriodoController implements Serializable {
    ...
    @EJB
    private com.sic.facade.PeriodoFacade ejbFacade;
    ...
    public PeriodoFacade getEjbFacade() {
        return ejbFacade;
    }

    public void setEjbFacade(PeriodoFacade ejbFacade) {
    ...
    public void cargarPeriodo() {
        ...
        actual = getFacade().getSingleResult("Periodo.findCurrent");
    }
    ...
    public static class PeriodoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Periodo) {
                ...
                return getStringKey(o.getNumeroPeriodo());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + PeriodoController.class.getName());
            }
        }
    }
}
