...
public class CostoActividadController implements Serializable {
    ...
    @EJB
    private com.sic.facade.CostoActividadFacade ejbFacade;
    ...
    public CostoActividad getSelected() {
        if (current == null) {
            ...
            current.setCostoActividadPK(new com.sic.entity.CostoActividadPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public static class CostoActividadControllerConverter implements Converter {
        ...
        com.sic.entity.CostoActividadPK getKey(String value) {
            com.sic.entity.CostoActividadPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.sic.entity.CostoActividadPK();
            key.setNumeroPeriodo(Long.parseLong(values[0]));
            key.setIdActividad(values[1]);
            return key;
        }

        String getStringKey(com.sic.entity.CostoActividadPK value) {
