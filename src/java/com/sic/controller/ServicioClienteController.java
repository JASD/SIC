...
import com.sic.entity.ServicioClientePK;
import com.sic.entity.TipoServicio;
import com.sic.facade.ServicioClienteFacade;
...
public class ServicioClienteController implements Serializable {
    ...
    @EJB
    private com.sic.facade.ServicioClienteFacade ejbFacade;
    ...
    public ServicioCliente getSelected() {
        if (current == null) {
            ...
            current.setServicioClientePK(new com.sic.entity.ServicioClientePK());
            selectedItemIndex = -1;
        }
        return current;
    }
   ...
   public void guardarServicio(ActionEvent event){
    ...
    public static class ServicioClienteControllerConverter implements Converter {
        ...
        com.sic.entity.ServicioClientePK getKey(String value) {
            com.sic.entity.ServicioClientePK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.sic.entity.ServicioClientePK();
        ...
        String getStringKey(com.sic.entity.ServicioClientePK value) {
