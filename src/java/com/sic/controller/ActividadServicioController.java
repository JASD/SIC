...
import com.sic.entity.ActividadServicioPK;
import com.sic.entity.CostoActividad;
import com.sic.entity.CostoActividadPK;
import com.sic.entity.Periodo;
import com.sic.entity.Servicio;
import com.sic.facade.ActividadServicioFacade;

import com.sic.facade.CostoActividadFacade;
...
public class ActividadServicioController implements Serializable {
    ...
    @EJB
    private com.sic.facade.ActividadServicioFacade ejbFacade;
    ...
    public ActividadServicio getSelected() {
        if (current == null) {
            ...
            current.setActividadServicioPK(new com.sic.entity.ActividadServicioPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public static class ActividadServicioControllerConverter implements Converter {
        ...
        com.sic.entity.ActividadServicioPK getKey(String value) {
            com.sic.entity.ActividadServicioPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.sic.entity.ActividadServicioPK();
        ...
        String getStringKey(com.sic.entity.ActividadServicioPK value) {
