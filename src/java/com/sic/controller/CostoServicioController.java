...
public class CostoServicioController implements Serializable {
    ...
    @EJB
    private com.sic.facade.CostoServicioFacade ejbFacade;
    ...
    public CostoServicio getSelected() {
        if (current == null) {
            ...
            current.setCostoServicioPK(new com.sic.entity.CostoServicioPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public static class CostoServicioControllerConverter implements Converter {
        ...
        com.sic.entity.CostoServicioPK getKey(String value) {
            com.sic.entity.CostoServicioPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.sic.entity.CostoServicioPK();
            key.setIdServicio(values[0]);
            key.setNumeroPeriodo(Long.parseLong(values[1]));
            return key;
        }

        String getStringKey(com.sic.entity.CostoServicioPK value) {
