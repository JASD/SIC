...
public class PlanillaController implements Serializable {
    ...
    @EJB
    private com.sic.facade.PlanillaFacade ejbFacade;
    ...
    public Planilla getSelected() {
        if (current == null) {
            ...
            current.setPlanillaPK(new com.sic.entity.PlanillaPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public static class PlanillaControllerConverter implements Converter {
        ...
        com.sic.entity.PlanillaPK getKey(String value) {
            com.sic.entity.PlanillaPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.sic.entity.PlanillaPK();
            key.setNumeroPeriodo(Long.parseLong(values[0]));
            key.setIdEmpleado(values[1]);
            return key;
        }

        String getStringKey(com.sic.entity.PlanillaPK value) {
